...
public final class CommanderBooleanIntermediary implements BooleanIntermediary {
  ...
  public static final CommanderBooleanIntermediary TRUE =
      new CommanderBooleanIntermediary(BooleanExpression.constant(true));
  public static final CommanderBooleanIntermediary FALSE =
      new CommanderBooleanIntermediary(BooleanExpression.constant(false));

  public static final Codec<CommanderBooleanIntermediary> CODEC = BooleanExpression.CODEC.xmap(
      CommanderBooleanIntermediary::new, CommanderBooleanIntermediary::getExpression);
