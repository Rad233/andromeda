...
public class RegistryLoaderMixin {
    ...
    private static DataResult<?> andromeda$cancelDecode(Decoder<?> instance, DynamicOps<?> ops, Object input, Operation<DataResult<?>> original, @Local Identifier identifier, @Local JsonElement json) {
        ...
        if (identifier.getNamespace().equals("andromeda") && json.isJsonObject() &&
    ...
    private static Object andromeda$cancelGetOrThrow(DataResult<?> instance, boolean allowPartial, Consumer<String> onError, Operation<?> original) {
    ...
    private static boolean andromeda$cancelEntryAddition(MutableRegistry<?> instance, RegistryKey<?> tRegistryKey, Object t, Lifecycle lifecycle) {
        return t != null;
    }
}
