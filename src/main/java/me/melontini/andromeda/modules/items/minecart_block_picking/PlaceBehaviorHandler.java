...
public class PlaceBehaviorHandler {
  ...
  public static void init() {
    registerPlaceBehavior(Items.CHEST_MINECART, (stack, world, d, e, f, g, pos) -> {
      ChestMinecartEntity chestMinecart = (ChestMinecartEntity)
          AbstractMinecartEntity.create(world, d, e + g, f, AbstractMinecartEntity.Type.CHEST);
    ...
    registerPlaceBehavior(Items.HOPPER_MINECART, (stack, world, d, e, f, g, pos) -> {
      HopperMinecartEntity hopperMinecart = (HopperMinecartEntity)
          AbstractMinecartEntity.create(world, d, e + g, f, AbstractMinecartEntity.Type.HOPPER);
    ...
    registerPlaceBehavior(Items.FURNACE_MINECART, (stack, world, d, e, f, g, pos) -> {
      FurnaceMinecartEntity furnaceMinecart = (FurnaceMinecartEntity)
          AbstractMinecartEntity.create(world, d, e + g, f, AbstractMinecartEntity.Type.FURNACE);
  ...
  public interface PlaceBehavior {
    AbstractMinecartEntity dispense(
        ItemStack stack, World world, double d, double e, double f, double g, BlockPos pos);
  }
}
