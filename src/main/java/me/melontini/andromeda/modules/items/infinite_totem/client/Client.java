    ...
    Client() {
        ClientPlayNetworking.registerGlobalReceiver(Main.USED_CUSTOM_TOTEM, (client, handler, buf, responseSender) -> {
            ...
            client.execute(() -> {
                ...
                client.particleManager.addEmitter(Objects.requireNonNull(entity, "(Andromeda) Client received invalid entity ID"), particle, 30);
        ...
        ClientPlayNetworking.registerGlobalReceiver(Main.NOTIFY_CLIENT, (client, handler, packetByteBuf, responseSender) -> {
            ...
            client.execute(() -> {
                ItemEntity entity = (ItemEntity) Objects.requireNonNull(client.world, "client.world").getEntityLookup().get(uuid);
